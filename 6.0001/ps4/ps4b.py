...
class Message(object):
    ...
    def get_valid_words(self):
        ...
        return self.valid_words_copy #delete this line and replace with your code here
    ...
    def apply_shift(self, shift):
        ...
        '''
        shift_string = ""
        #using build_shift_dict to create apply_shift, example of modularity
...
class PlaintextMessage(Message):
    ...
    def get_encryption_dict(self):
        ...
        '''
        return self.encrypytion_dict.copy()
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for curr_shift in range(26):
            word_list = self.message_text.split(" ")
            word_list = self.apply_shift(curr_shift)
